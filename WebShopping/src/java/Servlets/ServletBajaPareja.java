 ...
 * @author José
 */
public class ServletBajaPareja extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/bajaPareja.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Se borro la Pareja exitosamente</h1>");
            out.println("</body>");
            out.println("</html>");
    }
    }
