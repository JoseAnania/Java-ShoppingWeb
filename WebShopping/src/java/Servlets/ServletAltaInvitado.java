 ...
 * @author José
 */
public class ServletAltaInvitado extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList lista2 = con.listarTipoRelacion();
            request.setAttribute("lista2", lista2);

            RequestDispatcher rd = getServletContext().getRequestDispatcher("/altaInvitado.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Se cargo el Invitado exitosamente</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
