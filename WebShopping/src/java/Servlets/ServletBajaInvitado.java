 ...
 * @author José
 */
public class ServletBajaInvitado extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/bajaInvitado.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Se borro el Invitado exitosamente</h1>");
            out.println("</body>");
            out.println("</html>");
    }
    }
