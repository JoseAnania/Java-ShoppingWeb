...
<html>
    ...
    <jsp:include page="scripts.jsp"></jsp:include>
        ...
        <div class="center container">
            ...
            <h3 class="header center grey-text">Alta de Invitados</h3>

            <form method="POST" action="ServletAltaInvitado">
                <div class="row">
                    <div class="input-field col s4 offset-s4">

                        <label for="nombreI">Invitado</label>
                ...
                <div class="row">
                    <div class="input-field col s4 offset-s4">
                        ...
                        <select name="cboPareja" id="cboPareja" required="requiered">
                            <option value="" disabled selected> Seleccione Pareja</option>
            ...
            <div class="row">
                <div class="input-field col s4 offset-s4">
                    ...
                    <select name="cboTipoRelacion" id="cboTipoRelacion" required="requiered">
                        <option value="" disabled selected> Seleccione Tipo de Relación</option>
                        <c:forEach items="${lista2}" var="TR">
