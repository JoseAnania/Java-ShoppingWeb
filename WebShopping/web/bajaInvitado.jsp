...
<html>
    ...
    <jsp:include page="scripts.jsp"></jsp:include>
        ...
        <div class="center container">
            ...
            <h3 class="header center grey-text">Baja de Invitados</h3>

            <form method="POST" action="ServletBajaInvitado">     

                <div class="row">
                    <div class="input-field col s4 offset-s4">

                        <select name="cboInvitado" id="cboInvitado" required="requiered">
                            <option value="" disabled selected> Seleccione el Invitado</option>
