...
<html>
    ...
    <body>
        ...
        <h3 class="header center grey-text">Editar Parejas</h3>
        
        <form method="POST" action="ServletModificarPareja">
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s4 offset-s4">
                    ...
                    <input type="text" name="fechaCasamiento"/>
            ...
            <div class="row">
                <div class="input-field col s4 offset-s4">
                    ...
                    <select name="cboComercio" id="cboComercio" required="requiered">
