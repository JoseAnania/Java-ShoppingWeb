...
<html>
    ...
    <jsp:include page="scripts.jsp"></jsp:include>
        <div class="container">   
            <h3 class="header center grey-text">Seleccione una Pareja</h3>
            <table class="table striped">
                ...
                <c:forEach items="${lista}" var="P">
                    <tr>
                        ...
                        <td>
                            <a href="ServletListaRegalo?idP=${P.idP}">
                                <div class="row center" id="btnAceptar">
                                    <button class="btn waves-effect waves-#01579b light-blue darken-4" type="submit" name="Aceptar">Lista
