...
<html>
    ...
    <body>
        ...
        <div class="container">   
            <h3 class="header center grey-text">Lista de Invitados</h3>
            <table class="table striped">
                <thead>
                    
                    <tr><th>Nº</th><th>Nombre</th><th>Pareja</th><th>Tipo de Relación</th></tr>
                    
                </thead>
                <tbody>
                    <c:forEach items="${lista}" var="I">
                
                <tr><td>${I.idI}</td><td>${I.nombreI}</td><td>${I.nombre1} y ${I.nombre2}</td><td>${I.nombreTR}</td></tr>
