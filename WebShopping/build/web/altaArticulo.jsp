...
<html>
    ...
    <jsp:include page="scripts.jsp"></jsp:include>
        ...
        <div class="center container">
            ...
            <h3 class="header center grey-text">Alta de Artículos</h3>
            ...
            <form method="POST" action="ServletAltaArticulo">
                ...
                <div class="row">
                    <div class="input-field col s4 offset-s4">
                        ...
                        <label for="denominacionA">Denominación</label>
                ...
                <div class="row">
                    <div class="input-field col s4 offset-s4">
                        ...
                        <select name="cboTipoArticulo" id="cboTipoArticulo" required="requiered">
                            <option value="" disabled selected> Seleccione de Artículo</option>
